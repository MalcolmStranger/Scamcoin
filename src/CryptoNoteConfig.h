...
const unsigned EMISSION_SPEED_FACTOR                         = EMISSION_SPEED_FACTOR;
...
const char     CRYPTONOTE_NAME[]                             = "Scamcoin";
...
const int      P2P_DEFAULT_PORT                              = 5364;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 5396;
